...
CREATE TABLE `Atom` (
  ...
  `atom` enum('front','interior','rear') COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `Attribute` (
  ...
  `type` enum('string','uint','float','dict','date') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `name` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `AttributeMap` (
  ...
  `sticky` enum('yes','no') COLLATE utf8mb3_unicode_ci DEFAULT 'no',
...
CREATE TABLE `AttributeValue` (
  ...
  `string_value` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `CachedPAV` (
  `object_id` int(10) unsigned NOT NULL,
  `port_name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `CachedPVM` (
  `object_id` int(10) unsigned NOT NULL,
  `port_name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `vlan_mode` enum('access','trunk') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'access',
...
CREATE TABLE `Chapter` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sticky` enum('yes','no') COLLATE utf8mb3_unicode_ci DEFAULT 'no',
  `name` char(128) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Config` (
  `varname` char(32) COLLATE utf8mb3_unicode_ci NOT NULL,
  `varvalue` text COLLATE utf8mb3_unicode_ci NOT NULL,
  `vartype` enum('string','uint') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'string',
  `emptyok` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'no',
  `is_hidden` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'yes',
  `is_userdefined` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'no',
...
CREATE TABLE `Dictionary` (
  ...
  `dict_sticky` enum('yes','no') COLLATE utf8mb3_unicode_ci DEFAULT 'no',
  `dict_value` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=50000 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `EntityLink` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_entity_type` enum('location','object','rack','row') COLLATE utf8mb3_unicode_ci NOT NULL,
  `parent_entity_id` int(10) unsigned NOT NULL,
  `child_entity_type` enum('location','object','rack','row') COLLATE utf8mb3_unicode_ci NOT NULL,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`racktables`@`%`*/ /*!50003 TRIGGER `EntityLink-before-insert` BEFORE INSERT ON `EntityLink` FOR EACH ROW
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`racktables`@`%`*/ /*!50003 TRIGGER `EntityLink-before-update` BEFORE UPDATE ON `EntityLink` FOR EACH ROW
EntityLinkTrigger:BEGIN
  DECLARE parent_objtype, child_objtype, count INTEGER;
...
CREATE TABLE `File` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `type` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `FileLink` (
  ...
  `entity_type` enum('ipv4net','ipv4rspool','ipv4vs','ipvs','ipv6net','location','object','rack','row','user') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'object',
...
CREATE TABLE `IPv4Address` (
  ...
  `name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `comment` char(255) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `reserved` enum('yes','no') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `IPv4Allocation` (
  ...
  `ip` int(10) unsigned NOT NULL DEFAULT 0,
  `name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `type` enum('regular','shared','virtual','router','point2point','sharedrouter') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'regular',
...
CREATE TABLE `IPv4LB` (
  ...
  `prio` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `vsconfig` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `rsconfig` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `IPv4Log` (
  ...
  `user` varchar(64) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `IPv4NAT` (
  `object_id` int(10) unsigned NOT NULL DEFAULT 0,
  `proto` enum('TCP','UDP','ALL') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'TCP',
  ...
  `description` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `IPv4Network` (
  ...
  `name` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `IPv4RS` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `inservice` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'no',
...
CREATE TABLE `IPv4VS` (
  ...
  `proto` enum('TCP','UDP','MARK') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'TCP',
  `name` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `vsconfig` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `rsconfig` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `LDAPCache` (
  `presented_username` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  `successful_hash` char(40) COLLATE utf8mb3_unicode_ci NOT NULL,
  `first_success` timestamp NOT NULL DEFAULT current_timestamp(),
  `last_retry` timestamp NULL DEFAULT NULL,
  `displayed_name` char(128) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `memberof` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `Link` (
  ...
  `cable` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`racktables`@`%`*/ /*!50003 TRIGGER `Link-before-insert` BEFORE INSERT ON `Link` FOR EACH ROW LinkTrigger:BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`racktables`@`%`*/ /*!50003 TRIGGER `Link-before-update` BEFORE UPDATE ON `Link` FOR EACH ROW LinkTrigger:BEGIN
  DECLARE tmp, porta_type, portb_type, count INTEGER;
...
CREATE TABLE `MountOperation` (
  ...
  `user_name` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `Object` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `label` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `objtype_id` int(10) unsigned NOT NULL DEFAULT 1,
  `asset_no` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `has_problems` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'no',
  `comment` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `asset_no` (`asset_no`),
  KEY `id-tid` (`id`,`objtype_id`),
  KEY `type_id` (`objtype_id`,`id`)
) ENGINE=InnoDB AUTO_INCREMENT=984 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ObjectLog` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `object_id` int(10) unsigned NOT NULL,
  `user` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  `date` datetime NOT NULL,
...
CREATE TABLE `PatchCableConnector` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `origin` enum('default','custom') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'custom',
  `connector` char(32) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `PatchCableHeapLog` (
  ...
  `date` datetime NOT NULL,
  `user` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  `message` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `PatchCableType` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `origin` enum('default','custom') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'custom',
  `pctype` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `Plugin` (
  `name` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `longname` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `version` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  `home_url` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `state` enum('disabled','enabled') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'disabled',
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Port` (
  ...
  `l2address` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `reservation_comment` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `label` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3275 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `PortAllowedVLAN` VALUES (979,'gi0/1',7),(979,'gi0/1',8),(979,'gi0/1',9),(979,'gi0/10',9),(979,'gi0/11',9),(979,'gi0/12',9),(979,'gi0/13',3),(979,'gi0/14',9),(979,'gi0/15',9),(979,'gi0/16',9),(979,'gi0/17',9),(979,'gi0/18',9),(979,'gi0/19',9),(979,'gi0/2',7),(979,'gi0/2',8),(979,'gi0/2',9),(979,'gi0/20',9),(979,'gi0/21',9),(979,'gi0/22',9),(979,'gi0/23',9),(979,'gi0/24',3),(979,'gi0/24',7),(979,'gi0/24',8),(979,'gi0/24',9),(979,'gi0/3',9),(979,'gi0/4',9),(979,'gi0/5',9),(979,'gi0/6',9),(979,'gi0/7',9),(979,'gi0/8',9),(979,'gi0/9',9),(980,'gi0/0/1',1),(980,'gi0/0/1',11),(980,'gi0/0/1',12),(980,'gi0/0/1',13),(980,'gi0/0/10',1),(980,'gi0/0/11',1),(980,'gi0/0/12',1),(980,'gi0/0/13',1),(980,'gi0/0/14',1),(980,'gi0/0/15',1),(980,'gi0/0/16',1),(980,'gi0/0/17',1),(980,'gi0/0/18',1),(980,'gi0/0/19',1),(980,'gi0/0/2',1),(980,'gi0/0/20',1),(980,'gi0/0/21',1),(980,'gi0/0/22',1),(980,'gi0/0/23',1),(980,'gi0/0/24',1),(980,'gi0/0/25',1),(980,'gi0/0/26',1),(980,'gi0/0/27',1),(980,'gi0/0/28',1),(980,'gi0/0/29',1),(980,'gi0/0/3',1),(980,'gi0/0/30',1),(980,'gi0/0/31',1),(980,'gi0/0/32',1),(980,'gi0/0/33',1),(980,'gi0/0/34',1),(980,'gi0/0/35',1),(980,'gi0/0/36',1),(980,'gi0/0/37',1),(980,'gi0/0/38',1),(980,'gi0/0/39',1),(980,'gi0/0/4',3),(980,'gi0/0/40',1),(980,'gi0/0/41',1),(980,'gi0/0/42',1),(980,'gi0/0/43',1),(980,'gi0/0/44',1),(980,'gi0/0/45',1),(980,'gi0/0/46',1),(980,'gi0/0/47',1),(980,'gi0/0/48',3),(980,'gi0/0/48',5),(980,'gi0/0/48',11),(980,'gi0/0/48',12),(980,'gi0/0/48',13),(980,'gi0/0/5',5),(980,'gi0/0/6',1),(980,'gi0/0/7',1),(980,'gi0/0/8',1),(980,'gi0/0/9',1),(981,'gi0/1',3),(981,'gi0/1',7),(981,'gi0/1',8),(981,'gi0/1',9),(981,'gi0/10',1),(981,'gi0/11',1),(981,'gi0/12',1),(981,'gi0/2',1),(981,'gi0/3',3),(981,'gi0/3',5),(981,'gi0/3',11),(981,'gi0/3',12),(981,'gi0/3',13),(981,'gi0/4',1),(981,'gi0/5',1),(981,'gi0/6',1),(981,'gi0/7',1),(981,'gi0/8',1),(981,'gi0/9',1);
...
CREATE TABLE `PortInnerInterface` (
  ...
  `iif_name` char(16) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `PortOuterInterface` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `oif_name` char(48) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `oif_name` (`oif_name`)
) ENGINE=InnoDB AUTO_INCREMENT=2000 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `RackSpace` (
  ...
  `atom` enum('front','interior','rear') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'interior',
  `state` enum('A','U','T') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'A',
  `object_id` int(10) unsigned DEFAULT NULL,
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Script` (
  `script_name` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  `script_text` longtext COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `TagStorage` (
  `entity_realm` enum('file','ipv4net','ipv4rspool','ipv4vs','ipvs','ipv6net','location','object','rack','user','vst') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'object',
  `entity_id` int(10) unsigned NOT NULL,
  `tag_id` int(10) unsigned NOT NULL DEFAULT 0,
  `tag_is_assignable` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'yes',
  `user` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `TagTree` (
  ...
  `is_assignable` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'yes',
  `tag` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `TagTree` VALUES (1,NULL,'yes','testing',NULL,NULL),(2,NULL,'yes','production',NULL,NULL),(5,10,'yes','WAN link',NULL,NULL),(6,NULL,'yes','racks',NULL,NULL),(7,6,'yes','tall racks',NULL,NULL),(8,6,'yes','low racks',NULL,NULL),(9,NULL,'yes','load balancer',NULL,NULL),(10,NULL,'yes','network',NULL,NULL),(11,10,'yes','small network',NULL,NULL),(12,10,'yes','medium network',NULL,NULL),(16,NULL,'yes','XKCD',NULL,NULL),(17,16,'yes','romance',NULL,NULL),(18,16,'yes','sarcasm',NULL,NULL),(19,16,'yes','math',NULL,NULL),(20,16,'yes','language',NULL,NULL),(21,NULL,'yes','vlan template',NULL,NULL),(22,21,'yes','access switch template',NULL,NULL),(23,21,'yes','distribution switch template',NULL,NULL);
...
CREATE TABLE `UserAccount` (
  ...
  `user_name` char(64) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `user_password_hash` char(40) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `user_realname` char(64) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
CREATE TABLE `VLANDescription` (
  ...
  `vlan_id` int(10) unsigned NOT NULL DEFAULT 0,
  `vlan_type` enum('ondemand','compulsory','alien') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'ondemand',
  `vlan_descr` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `VLANSTRule` (
  ...
  `port_pcre` char(255) COLLATE utf8mb3_unicode_ci NOT NULL,
  `port_role` enum('access','trunk','anymode','uplink','downlink','none') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'none',
  `wrt_vlans` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `description` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `VLANSwitch` (
  ...
  `out_of_sync` enum('yes','no') COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'yes',
...
INSERT INTO `VLANSwitch` VALUES (979,2,1,4,'no',0,'2012-09-09 16:11:57','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'),(980,2,2,4,'no',0,'2012-09-09 16:16:22','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'),(981,2,3,1,'no',0,'2012-09-09 16:16:53','0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00');
...
CREATE TABLE `VLANSwitchTemplate` (
  ...
  `description` char(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `saved_by` char(64) COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `description` (`description`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `VSEnabledPorts` (
  `object_id` int(10) unsigned NOT NULL,
  `vs_id` int(10) unsigned NOT NULL,
  `proto` enum('TCP','UDP','MARK') COLLATE utf8mb3_unicode_ci NOT NULL,
...
/*!50013 DEFINER=`racktables`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2021-12-31 15:43:57
